...
public class ContadorConcurrente {
    ...
    // Contador atómico que será incrementado por los hilos
    ...
    static class ContadorHilo extends Thread {
        @Override
        public void run() {
            // Incrementa el contador una cantidad específica de veces
            for (int i = 0; i < INCREMENTOS_POR_HILO; i++) {
                contador.incrementAndGet();  // Incrementa el contador de forma atómica
            }
        }
    }
